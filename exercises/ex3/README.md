...
2. Open the *User Action Menu* by clicking on your profile in the top right corner of the UI.
3. Choose *Adapt UI* to start the *UI Adaptation*.
4. Click on a colum of the *Poetry Slams* table with the right mouse button.
5. Select *View Settings*.
6. Select the *Price* column.
7. Close the popup.
8. Activate the new version on the top left.
9. Enter a version title, e.g. *Add Price*.
